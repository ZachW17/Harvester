...
namespace Harvester
{
    ...
    public class Engine : Microsoft.Xna.Framework.Game
    {
        ...
        //Texture Dictionary, note use asset manager to retrieve values because it has a try catch in it
        private static Dictionary<String, Texture2D> _textureDic;
        //Spritefont Dictionary, note use asset manager to retrieve values because it has a try catch in it
        private static Dictionary<String, SpriteFont> _spritefontDic;
        //Audio Dictionary
        private static Dictionary<String, SoundEffect> _audioDic;
        ...
        //dictionaries
        public static Dictionary<String, Texture2D> TextureDic{get { return _textureDic; }}
        public static Dictionary<String, SpriteFont> SpriteFontDic{get { return _spritefontDic; }}
        public static Dictionary<String, SoundEffect> AudioDic { get { return _audioDic; } }
        //mouse states
        ...
        protected override void Initialize()
        {
            ...
            _audioDic = new Dictionary<string, SoundEffect>();
            //Temporary Texture
            ...
            //Load all sounds
            foreach (String s in AssetManager.Instance.FindFiles(".wav"))
            {
                //Add them to the dictionary, . + s means it adds the . needed to direct the file path similar to @\.....
                _audioDic.Add(s, tempSoundEffect = Content.Load<SoundEffect>("." + s));
            }
            #endregion
